          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              {settings.social?.facebook && (
                <a href={settings.social.facebook} className="text-gray-100 hover:text-white transition-colors">
                  <Facebook size={20} />
                  <span className="sr-only">Facebook</span>
                </a>
              )}
              {settings.social?.instagram && (
                <a href={settings.social.instagram} className="text-gray-100 hover:text-white transition-colors">
                  <Instagram size={20} />
                  <span className="sr-only">Instagram</span>
                </a>
              )}
              {settings.social?.linkedin && (
                <a href={settings.social.linkedin} className="text-gray-100 hover:text-white transition-colors">
                  <Linkedin size={20} />
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center">
                ...
                <a href={settings.phone.href} className="text-gray-100 hover:text-white transition-colors">
            ...
            <div className="mt-4">
              ...
              <p className="text-gray-100 text-sm">{settings.hours}</p>
            </div>
          </div>
        </div>
