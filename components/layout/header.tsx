        ...
        <div className="flex h-20 items-center justify-between">
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center">
              <span className="text-2xl font-bold text-blue-600">Very Good Marketing</span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex">
            <CustomButton asChild variant="blue" href="/contact">
              Free Consultation
            </CustomButton>
          </div>
        ...
        >
          ...
          <nav className="flex flex-col items-center justify-center space-y-6 px-4 text-center">
            ...
            <div className="pt-8 mt-4">
              <CustomButton asChild variant="blue" size="lg" onClick={closeMenu}>
