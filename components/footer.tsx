          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <a
                  href="mailto:info@verygoodmarketing.com"
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+15551234567" className="text-gray-100 hover:text-white transition-colors">
                  (555) 123-4567
                </a>
              </li>
            </ul>
            <div className="mt-4">
              ...
              <p className="text-gray-100 text-sm">Monday - Friday: 9am - 5pm</p>
              <p className="text-gray-100 text-sm">Saturday - Sunday: Closed</p>
            </div>
          </div>
        </div>
