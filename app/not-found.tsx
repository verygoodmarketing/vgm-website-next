        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          <div>
            ...
            <ul className="space-y-1">
              <li>
                <Link href="/services#website-creation" className="text-blue-600 hover:text-blue-800 transition-colors">
                  Website Creation
                </Link>
              </li>
              <li>
                <Link href="/services#google-ads" className="text-blue-600 hover:text-blue-800 transition-colors">
                  Google Ads
                </Link>
              </li>
              <li>
                <Link href="/services#social-media" className="text-blue-600 hover:text-blue-800 transition-colors">
                  Social Media
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-1">
              ...
              <li>
                <Link href="/contact?tab=schedule" className="text-blue-600 hover:text-blue-800 transition-colors">
                  Schedule a Call
                </Link>
              </li>
            </ul>
