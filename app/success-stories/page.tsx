...
export const metadata: Metadata = {
  ...
  description: 'See how service businesses like yours have achieved real results with Very Good Marketing. Read our client success stories and case studies.',
}
...
export default async function SuccessStoriesPage() {
  ...
  const testimonialsByIndustry = testimonials.reduce((acc, testimonial) => {
  ...
  const sortedIndustries = Object.keys(testimonialsByIndustry).sort((a, b) => 
    testimonialsByIndustry[b].length - testimonialsByIndustry[a].length
  )
      ...
      <Container>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials
              ...
              .slice(0, 3)
              .map(testimonial => (
                <Card key={testimonial.id} className="p-6 border-blue-200 shadow-md">
                  {testimonial.rating && (
        ...
        <section className="mt-20 text-center bg-blue-50 p-10 rounded-lg">
          ...
          <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
            We've helped hundreds of service businesses transform their online presence and grow their customer base. Let's talk about how we can help your business too.
          </p>
