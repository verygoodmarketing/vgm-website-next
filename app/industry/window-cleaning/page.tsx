  ...
  return (
    <>
      ...
      <div className="relative h-[60vh] min-h-[500px] w-full overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-sky-900/80 to-black/50 z-10"></div>
        <Image 
      ...
      <section className="py-16 bg-gradient-to-r from-sky-600 to-sky-800 relative overflow-hidden">
