        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <CustomButton variant="blue" href="/contact?service=website">
                Get Started
              </CustomButton>
            </div>
            ...
            <div className="relative h-[500px] rounded-lg overflow-hidden">
              <Image
                src="/images/service-business-website.jpg"
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              <CustomButton variant="blue" href="/contact?service=google-ads">
                Start Getting Leads Now
              </CustomButton>
            </div>
            <div className="relative h-[400px] rounded-lg overflow-hidden order-1 lg:order-2">
              <Image
                src="/placeholder.svg?height=800&width=600&text=Google+Ads"
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <CustomButton variant="blue" href="/contact?service=social-ads">
                Start Your Campaign
              </CustomButton>
            </div>
            <div className="relative h-[400px] rounded-lg overflow-hidden">
              <Image
                src="/placeholder.svg?height=800&width=600&text=Social+Media+Ads"
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              <CustomButton variant="blue" href="/contact?service=social-media">
                Boost Your Social Presence
              </CustomButton>
            </div>
            <div className="relative h-[400px] rounded-lg overflow-hidden order-1 lg:order-2">
              <Image
                src="/placeholder.svg?height=800&width=600&text=Social+Media+Marketing"
            ...
            <Card className="border-2 border-blue-100">
              ...
              <CardContent className="p-6">
                ...
                <div className="text-center">
                  ...
                  <CustomButton variant="blue" href="/contact?bundle=essential" className="w-full">
                    Get Started
                  </CustomButton>
                </div>
              </CardContent>
            ...
            <Card className="border-2 border-blue-600 shadow-lg relative">
              ...
              <CardContent className="p-6">
                ...
                <div className="text-center">
                  ...
                  <CustomButton variant="blue" href="/contact?bundle=complete" className="w-full">
                    Get Started
                  </CustomButton>
                </div>
              </CardContent>
            ...
            <Card className="border-2 border-blue-100">
              ...
              <CardContent className="p-6">
                ...
                <div className="text-center">
                  ...
                  <CustomButton variant="blue" href="/contact?bundle=ultimate" className="w-full">
                    Get Started
                  </CustomButton>
                </div>
              </CardContent>
