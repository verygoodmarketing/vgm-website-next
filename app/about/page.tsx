        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-[400px] rounded-lg overflow-hidden order-1 lg:order-2">
              <Image src="/images/service-businesses.jpg" alt="Service businesses" fill className="object-cover" />
            </div>
          </div>
        </Container>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="relative h-[300px]">
                <Image src="/placeholder.svg?height=600&width=600" alt="Team Member 1" fill className="object-cover" />
              </div>
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="relative h-[300px]">
                <Image src="/placeholder.svg?height=600&width=600" alt="Team Member 2" fill className="object-cover" />
              </div>
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="relative h-[300px]">
                <Image src="/placeholder.svg?height=600&width=600" alt="Team Member 3" fill className="object-cover" />
              </div>
              <div className="p-6">
